...
hdiutil verify artifacts/release/绘钥_2.0.2_aarch64.dmg
```
...
```bash
ditto artifacts/release/绘钥_2.0.2_aarch64.dmg \
  artifacts/release/Huiyao_2.0.2_aarch64.dmg
(
  cd artifacts/release
  shasum -a 256 Huiyao_2.0.2_aarch64.dmg \
    > Huiyao_2.0.2_aarch64.dmg.sha256
)
gh release create v2.0.2 \
  artifacts/release/Huiyao_2.0.2_aarch64.dmg \
  artifacts/release/Huiyao_2.0.2_aarch64.dmg.sha256 \
  --title "绘钥 2.0.2" \
