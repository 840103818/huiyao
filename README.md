...
当前版本：`2.0.0` · Bundle ID：`com.huiyao.studio` · 支持 Apple Silicon 与 macOS 12 及以上版本。
...
从 [GitHub Releases](https://github.com/840103818/huiyao/releases/latest) 下载 `Huiyao_2.0.0_aarch64.dmg`，打开后将“绘钥”拖入“应用程序”。
...
```bash
shasum -a 256 -c Huiyao_2.0.0_aarch64.dmg.sha256
```
